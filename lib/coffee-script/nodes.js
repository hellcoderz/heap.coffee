...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      var node, trans;
      if (trans = typeof this.transform === "function" ? this.transform(o) : void 0) {
        return trans.compile(o, lvl);
      }
      o = extend({}, o);
      if (lvl) {
        o.level = lvl;
  ...
  exports.DeclareType = DeclareType = (function(_super) {
    ...
    function DeclareType(variables, type) {
      this.variables = variables;
      this.type = type;
    }

    DeclareType.prototype.children = ['variables'];

    DeclareType.prototype.isStatement = YES;

    DeclareType.prototype.compile = function(o, level) {
      var name, names, scope, v;
      scope = o.scope;
      names = (function() {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ...
          if ((_ref3 = scope.parent) != null ? _ref3.check(name) : void 0) {
            throw TypeError("type for `" + name + "' not declared in the same scope");
          }
          scope.find(name);
          _results.push(v.compile(o, LEVEL_LIST));
        }
        return _results;
      }).call(this);
      return "" + o.indent + "// " + (names.join(', ')) + " :: " + this.type;
    };
    ...
    DeclareType.prototype.toString = function(idt) {
      ...
      return '\n' + idt + this.constructor.name + this.variables + '\n' + idt + TAB + this.type;
    };
