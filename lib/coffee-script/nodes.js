...
(function() {
  var Access, Arr, ArrowType, Assign, Base, Block, Call, Cast, Class, Closure, Code, Comment, DeclareType, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, ObjField, Op, Param, Parens, PointerType, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, StructField, StructType, Switch, TAB, THIS, Throw, Try, TypeArr, TypeAssign, TypeName, TypeObj, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, tystr, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.transform = function(o) {
      var attr, child, trans, _i, _len, _ref2;
      _ref2 = this.children;
  ...
  exports.TypeObjField = ObjField = (function(_super) {

    __extends(ObjField, _super);

    function ObjField(name, type) {
      this.name = name;
      this.type = type;
    }

    ObjField.prototype.toString = function(lvl) {
      if (lvl == null) {
        lvl = 0;
      }
  ...
  exports.TypeAssign = TypeAssign = (function(_super) {
    ...
    TypeAssign.prototype.compile = function(o, level) {
      return "" + o.indent + "// type " + this.name + " = " + this.type;
    };
  ...
  exports.DeclareType = DeclareType = (function(_super) {
    ...
    DeclareType.prototype.compile = function(o, level) {
      var code, name, scope, ty, _i, _len, _ref2, _ref3, _ref4;
      code = "";
      scope = o.scope;
      _ref2 = this.variables;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        _ref3 = _ref2[_i], name = _ref3.name, ty = _ref3.type;
