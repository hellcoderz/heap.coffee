...
(function() {
  var Access, Arr, ArrowType, Assign, Base, Block, Call, Cast, Class, Closure, Code, Comment, DeclareType, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, PointerType, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, StructField, StructType, Switch, TAB, THIS, Throw, Try, TypeArr, TypeAssign, TypeName, TypeObj, TypeObjField, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, tystr, unfoldSoak, utility, _ref, _ref1,
  ...
  _ref1 = require('./helpers'), compact = _ref1.compact, flatten = _ref1.flatten, extend = _ref1.extend, merge = _ref1.merge, del = _ref1.del, starts = _ref1.starts, ends = _ref1.ends, last = _ref1.last, tystr = _ref1.tystr;
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      ...
      if (o.level === LEVEL_TOP || !node.isStatement(o)) {
        return node.transform(o).compileNode(o);
      } else {
        return node.compileClosure(o);
      }
    };

    Base.prototype.transform = function(o) {
      var attr, child, node, trans, _i, _len, _ref2;
      _ref2 = this.children;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (child = this[attr]) {
          if (child instanceof Array) {
            if (child.length) {
              this.transformArray(child, o);
            }
          } else if (trans = typeof child.transformNode === "function" ? child.transformNode(o) : void 0) {
            this[attr] = trans;
          } else {
            node = child;
    ...
    Base.prototype.transformArray = function(arr, o) {
      var el, i, trans, _i, _len, _results;
      _results = [];
      for (i = _i = 0, _len = arr.length; _i < _len; i = ++_i) {
        el = arr[i];
        if (el instanceof Array) {
          _results.push(this.transformArray(el, o));
        } else if (trans = typeof el.transformNode === "function" ? el.transformNode(o) : void 0) {
          _results.push(arr[i] = trans);
        } else {
    ...
    Base.prototype.compileClosure = function(o) {
      ...
      o.sharedScope = true;
      return Closure.wrap(this).transform(o).compileNode(o);
    };
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      ...
      this.spaced = true;
      prelude = "";
      if (typeof this.transformRoot === "function") {
        this.transformRoot(o);
      }
      if (!o.bare) {
        ...
        if (preludeExps.length) {
          prelude = "" + (this.transform(o).compileNode(merge(o, {
            indent: ''
          }))) + "\n";
        }
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      ...
      if (i) {
        ...
        _ref4 = [this.transform(o).compileNode(o), spaced], code = _ref4[0], this.spaced = _ref4[1];
        this.expressions = rest;
      }
      post = this.transform(o).compileNode(o);
      scope = o.scope;
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.isSimpleNumber = function() {
      return SIMPLENUM.test(this.value);
    };
  ...
  exports.TypeName = TypeName = (function(_super) {
  ...
  exports.PointerType = PointerType = (function(_super) {
  ...
  exports.TypeArr = TypeArr = (function(_super) {

    __extends(TypeArr, _super);

    function TypeArr(elements) {
      this.elements = elements;
    }

    TypeArr.prototype.toString = function(lvl) {
      var e;
      if (lvl == null) {
        lvl = 0;
      }
  ...
  exports.TypeObj = TypeObj = (function(_super) {

    __extends(TypeObj, _super);

    function TypeObj(fields) {
      var field, i, names, _i, _len;
      this.fields = fields;
      this.names = names = {};
    ...
    TypeObj.prototype.toString = function(lvl) {
      if (lvl == null) {
        lvl = 0;
      }
      if (lvl > 0 && this.debugName) {
  ...
  exports.TypeObjField = TypeObjField = (function(_super) {

    __extends(TypeObjField, _super);

    function TypeObjField(name, type) {
      this.name = name;
      this.type = type;
    }

    TypeObjField.prototype.toString = function(lvl) {
      if (lvl == null) {
        lvl = 0;
      }
      return "" + this.name + ": " + (tystr(this.type, lvl + 1));
    };
  ...
  exports.ArrowType = ArrowType = (function(_super) {

    __extends(ArrowType, _super);

    function ArrowType(params, ret) {
      this.params = params;
      this.ret = ret;
    }

    ArrowType.prototype.toString = function(lvl) {
      var p;
      if (lvl == null) {
        lvl = 0;
      }
      if (lvl > 0 && this.debugName) {
        ...
        return "(" + (((function() {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            p = _ref2[_i];
            _results.push(tystr(p, lvl + 1));
          }
          return _results;
        }).call(this)).join(', ')) + ") -> " + (tystr(this.ret, lvl + 1));
      }
    };
  ...
  exports.StructType = StructType = (function(_super) {
    ...
    StructType.prototype.toString = function(lvl) {
      ...
      if (lvl > 0 && this.debugName) {
        ...
        return "struct { " + (((function() {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            f = _ref2[_i];
            _results.push(f.toString(lvl + 1));
          }
          return _results;
        }).call(this)).join(', ')) + " }";
      }
  ...
  exports.StructField = StructField = (function(_super) {

    __extends(StructField, _super);

    function StructField(name, type, offset, usePreviousOffset) {
      this.name = name;
      this.type = type;
      this.offset = offset;
      this.usePreviousOffset = usePreviousOffset;
    }

    StructField.prototype.toString = function(lvl) {
      var offset;
      if (lvl == null) {
        lvl = 0;
      }
      offset = this.offset != null ? this.offset : this.usePreviousOffset ? '-' : '+';
      return "[" + offset + "] " + this.name + " :: " + (tystr(this.type, lvl + 1));
    };
  ...
  exports.TypeAssign = TypeAssign = (function(_super) {

    __extends(TypeAssign, _super);

    function TypeAssign(name, type) {
    ...
    TypeAssign.prototype.children = ['type'];

    TypeAssign.prototype.isStatement = YES;

    TypeAssign.prototype.compile = function(o, level) {
      return "" + o.indent + "// type " + this.name + " = " + (tystr(this.type));
    };

    TypeAssign.prototype.toString = function(idt) {
      if (idt == null) {
        idt = '';
      }
      return '\n' + idt + this.constructor.name + ' ' + this.name + '\n' + idt + TAB + this.type;
    };
  ...
  exports.DeclareType = DeclareType = (function(_super) {

    __extends(DeclareType, _super);

    function DeclareType(typeables, type) {
      this.typeables = typeables;
      this.type = type;
    }

    DeclareType.prototype.children = ['typeables'];

    DeclareType.prototype.isStatement = YES;

    DeclareType.prototype.compile = function(o, level) {
      var code, i, name, scope, ty, _i, _len, _ref2, _ref3, _ref4;
      scope = o.scope;
      code = "";
      _ref2 = this.variables;
      for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
        _ref3 = _ref2[i], name = _ref3.name, ty = _ref3.type;
        if ((_ref4 = scope.parent) != null ? _ref4.check(name) : void 0) {
    ...
    DeclareType.prototype.toString = function(idt) {
      if (idt == null) {
        idt = '';
      }
      return '\n' + idt + this.constructor.name + this.typeables + '\n' + idt + TAB + this.type;
    };
  ...
  exports.Cast = Cast = (function(_super) {
    ...
    Cast.prototype.children = ['expr', 'type'];

    Cast.prototype.compileNode = function(o) {
      return this.expr.compile(o);
    };

    Cast.prototype.toString = function(idt) {
      if (idt == null) {
        idt = '';
      }
      return '\n' + idt + this.constructor.name + this.expr + '\n' + idt + TAB + this.type;
    };
  ...
  exports.Range = Range = (function(_super) {
    ...
    Range.prototype.compileArray = function(o) {
      ...
      if (this.fromNum && this.toNum) {
        o.index = i;
        body = this.transform(o).compileNode(o);
      } else {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (!(o.scope.shared = del(o, 'sharedScope'))) {
        o.frameSize = this.frameSize;
      }
      o.indent += TAB;
      delete o.bare;
