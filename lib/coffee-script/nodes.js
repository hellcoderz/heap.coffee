...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.unwrapValue = function() {
      var node;
      node = this;
      while (!(node instanceof Value || node === (node = node.unwrap()))) {
        continue;
      }
      return node;
    };
  ...
  exports.Cast = Cast = (function(_super) {
    ...
    function Cast(expr, type, generated) {
      this.generated = generated != null ? generated : false;
      if (!type) {
        return expr;
      }
      if (expr instanceof Cast && expr.type === type) {
        return expr;
      }
      this.lineno = expr.unwrapAll().lineno;
      this.expr = expr;
      this.type = type;
    }

    Cast.prototype.children = ['expr'];

    Cast.prototype.isStatement = function() {
      return this.expr.isStatement();
    };

    Cast.prototype.jumps = function() {
      return this.expr.jumps();
    };

    Cast.prototype.isEmpty = function() {
      return this.expr.isEmpty();
    };

    Cast.prototype.isComplex = function() {
      return this.expr.isComplex();
    };

    Cast.prototype.isChainable = function() {
      return this.expr.isChainable();
    };

    Cast.prototype.isAssignable = function() {
      return this.expr.isAssignable();
    };

    Cast.prototype.hasProperties = function() {
      var _base;
      return typeof (_base = this.expr).hasProperties === "function" ? _base.hasProperties() : void 0;
    };

    Cast.prototype.compile = function(o, lvl) {
      var expr, type;
      type = this.type;
      expr = this.expr;
      if (expr.type && ((type != null ? type.coerce : void 0) != null)) {
        this.expr = type.coerce(expr, expr.type);
      }
      return this.expr.compile(o, lvl);
    };

    Cast.prototype.unwrapCast = function() {
      var node;
      node = this;
      while (node !== (node = node instanceof Cast ? node.expr : node.unwrap())) {
        continue;
      }
      return node;
    };
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (this.paramTypes) {
        code += ' // :: (' + ((function() {
          ...
          _ref9 = this.paramTypes;
          _results = [];
          for (_o = 0, _len6 = _ref9.length; _o < _len6; _o++) {
            p = _ref9[_o];
            _results.push(tystr(p, 1));
          }
          return _results;
        }).call(this)).join(', ') + ')';
      }
