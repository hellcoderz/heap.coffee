...
(function() {
  var Access, Arr, ArrowType, Assign, Base, Block, Call, Cast, Class, Closure, Code, Comment, DeclareType, Deref, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, PointerType, RESERVED, Range, Ref, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, StructField, StructType, Switch, TAB, THIS, Throw, Try, TypeAssign, TypeName, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref, _ref1,
    ...
    PointerType.prototype.toString = function(lvl) {
      ...
      if (lvl > 0 && this.debugName) {
        ...
        if (this.onStack) {
          ...
          return '*' + this.base.toString(lvl + 1);
        }
      }
    };
    ...
    ArrowType.prototype.toString = function(lvl) {
      ...
      if (lvl > 0 && this.debugName) {
        ...
        return "(" + (((function() {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            p = _ref2[_i];
            _results.push(p.toString(lvl + 1));
          }
          return _results;
        }).call(this)).join(', ')) + ") -> " + (this.ret.toString(lvl + 1));
      }
    };
  ...
  exports.StructField = StructField = (function(_super) {
    ...
    StructField.prototype.toString = function(lvl) {
      ...
      return "[" + offset + "] " + this.name + " :: " + (this.type.toString(lvl + 1));
    };
  ...
  exports.Ref = Ref = (function(_super) {
    ...
    Ref.prototype.children = ['expr'];

    Ref.prototype.compileNode = function(o) {
  ...
  exports.Deref = Deref = (function(_super) {
