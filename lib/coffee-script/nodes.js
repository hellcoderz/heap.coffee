...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      ...
      node0 = (typeof this.transform === "function" ? this.transform(o) : void 0) || this;
      node = node0.unfoldSoak(o) || node0;
      node.tab = o.indent;
  ...
  exports.PointerType = PointerType = (function(_super) {
    ...
    function PointerType(base, onStack) {
      this.base = base;
      this.onStack = onStack != null ? onStack : false;
    }
  ...
  exports.DeclareType = DeclareType = (function(_super) {
    ...
    function DeclareType(variable, type) {
      this.variable = variable;
      this.type = type;
    }

    DeclareType.prototype.children = ['variable'];
    ...
    DeclareType.prototype.compile = function(o, level) {
      ...
      if ((_ref2 = scope.parent) != null ? _ref2.check(name) : void 0) {
        throw TypeError("type for `" + name + "' not declared in the same scope");
      }
      o.scope.find(name);
      return "" + o.indent + "// " + (this.variable.compile(o, LEVEL_LIST)) + " :: " + this.type;
    };
    ...
    DeclareType.prototype.toString = function(idt) {
      ...
      return '\n' + idt + this.constructor.name + this.variable + '\n' + idt + TAB + this.type;
    };
