...
(function() {
  ...
  Value.prototype.transform = function(o) {
    var base, cumulativeOffset, field, fty, inner, name, prop, props, spOffsets, stackDeref, v, vty, _i, _len, _ref2;
    ...
    if (inner instanceof Literal && o.frameSize) {
      ...
      if ((name = inner.value) in spOffsets) {
        stackDeref = new Value(U32, [new Index(stackOffsetExpr(spOffsets[name], this.computedType))]);
        if (props.length) {
          base = stackDeref;
        } else {
          return stackDeref;
