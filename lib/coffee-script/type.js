...
(function() {
  ...
  DeclareType.prototype.declareType = function(r, o) {
    ...
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      ...
      if (scope.check(name)) {
        error(this, "cannot redeclare typed variable `" + name + "'");
      }
