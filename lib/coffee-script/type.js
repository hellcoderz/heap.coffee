...
(function() {
  var Access, ArrowType, Assign, Base, Block, Call, Code, DeclareType, Deref, FREE, HEAP, HEAPV, I16H, I32H, Index, Literal, MALLOC, MEMCPY, Obj, Op, Parens, PointerType, PrimitiveType, Ref, Return, STACK, STACKV, Scope, StructType, TypeAssign, TypeName, U16H, U32H, Value, While, anyPtrTy, byteTy, extend, flatten, inlineMemcpy, intTy, makeDeref, newTypedScope, offsetExpr, opts, primTys, printWarn, returnExpressions, shortTy, structLiteral, uintTy, unify, unitTy, _ref, _ref1,
  ...
  unify = function(types, lty, rty, assign) {
    var base, i, lpty, lptys, pty, ptys, ret, rptys, _i, _len;
    if (lty === rty) {
      return lty;
    }
    if (!(lty && rty)) {
    ...
    if (lty instanceof PointerType && rty === anyPtrTy) {
      return lty;
    }
    if (rty instanceof PointerType && lty === anyPtrTy) {
      return rty;
    }
  ...
  Assign.prototype.computeType = function(r, o) {
    ...
    this.typeCached = true;
    if (!(lty = this.variable.unwrapAll().computeType(r, o))) {
      return;
    }
    rty = this.value.unwrapAll().computeType(r, o);
  ...
  Assign.prototype.transform = function(o) {
    ...
    return inlineMemcpy(lval.expr, this.value, ty, o);
  };
