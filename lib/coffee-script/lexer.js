...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      var colon, forcedIdentifier, id, input, match, prev, tag, _ref2, _ref3, _ref4;
      ...
      forcedIdentifier = colon || (prev = last(this.tokens)) && (((_ref2 = prev[0]) === '.' || _ref2 === '?.') || !prev.spaced && prev[0] === '@' || !(prev.spaced && ((_ref3 = last(this.tokens, 1)) != null ? _ref3.spaced : void 0)) && prev[0] === '::');
      tag = 'IDENTIFIER';
  ...
  COFFEE_KEYWORDS = ['undefined', 'then', 'unless', 'until', 'loop', 'of', 'by', 'when', 'struct', 'as', 'sizeof'];
