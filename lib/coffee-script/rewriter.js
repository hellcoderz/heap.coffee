...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.disambiguateTypeStuff = function() {
      return this.scanTokens(function(token, i, tokens) {
        var stack, tok, _ref, _ref1, _ref2, _ref3, _ref4;
        if (token[0] === '::' && (token.spaced || token.newLine) && ((_ref = tokens[i - 1]) != null ? _ref.spaced : void 0)) {
          token[0] = 'IS_TYPE';
        }
        if (token[0] === 'IDENTIFIER' && token[1] === 'type' && ((_ref1 = tokens[i + 1]) != null ? _ref1[0] : void 0) === 'IDENTIFIER' && ((_ref2 = tokens[i + 2]) != null ? _ref2[0] : void 0) === '=') {
          token[0] = 'TYPE';
        }
        if (token[0] === 'PARAM_START' && ((_ref3 = tokens[--i]) != null ? _ref3[0] : void 0) === 'IS_TYPE' && ((_ref4 = tokens[--i]) != null ? _ref4[0] : void 0) === ')') {
