...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.disambiguateTypeStuff = function() {
      return this.scanTokens(function(token, i, tokens) {
        var end, hasComma, stack, tok, _ref, _ref1, _ref2, _ref3, _ref4;
        if (token[0] === ':' && ((_ref = tokens[i + 1]) != null ? _ref[0] : void 0) === '=') {
          ...
          hasComma = false;
          while ((tok = (_ref2 = tokens[--i]) != null ? _ref2[0] : void 0) && (tok !== 'TERMINATOR' && tok !== 'INDENT')) {
            if (tok !== 'IDENTIFIER' && tok !== ',') {
              return 1;
            }
            hasComma || (hasComma = tok === ',');
          }
          if (hasComma) {
            tokens.splice(i + 1, 0, this.generate('DECL_START', '', token[2]));
          }
        } else if (token[0] === 'IDENTIFIER' && token[1] === 'type' && ((_ref3 = tokens[i + 1]) != null ? _ref3[0] : void 0) === 'IDENTIFIER' && ((_ref4 = tokens[i + 2]) != null ? _ref4[0] : void 0) === '=') {
          token[0] = 'TYPE';
