  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.disambiguateTypeStuff = function() {
      return this.scanTokens(function(token, i, tokens) {
        ...
        if (token[0] === '::' && (token.spaced || token.newLine) && ((_ref1 = tokens[i - 1]) != null ? _ref1.spaced : void 0)) {
          token[0] = 'IS_TYPE';
          end = i;
          hasComma = false;
        ...
        if (token[0] === 'IDENTIFIER' && token[1] === 'type' && ((_ref3 = tokens[i + 1]) != null ? _ref3[0] : void 0) === 'IDENTIFIER' && ((_ref4 = tokens[i + 2]) != null ? _ref4[0] : void 0) === '=') {
          token[0] = 'TYPE';
        }
        if (token[0] === 'PARAM_START' && tokens[--i][0] === 'IS_TYPE' && tokens[--i][0] === ')') {
